...
Since beta is a 5x1 matrix, the actual final equation looks like $y = \beta_{0,0} + (\beta_{1,0} \cdot x_{1}) + (\beta_{2,0} \cdot x_{2}) + (\beta_{3,0} \cdot x_{3}) + (\beta_{5,0} \cdot x_{5}) + (\beta_{5,0} \cdot x_{5})$.
