...
## Closing Details
My matrix struct(s) were definitely what I spent most of my time on in this project. It uses CRTP, which I think I implemented by accident when using templates for all my matrix structs. I made lazy evaluation, using wrappers for different functions like matrix adding and subtracting. Matrix multiplication unfortunately doesn't really benefit from the lazy evaluation, as you would have to compute a single item times a whole column every time you look up a number. Element wise multiplication works fine with this. It is a lot of fun to optimize this stuff. Even with the matrix struct(s) being what I spent the most time on, they were definitely not the hardest part. However, I had a lot of fun making them.

# Conclusion
I learned way more than from any of my C++ books making this, although I only have one C++ book. I learned file parsing with stringstream and "fstream" library. It was mostly the actual AI creation that was difficult (big surprise) where I had to look up how to make it learn, what "beta" was (in the context of this project), how to actually get accurate predictions, and what specific data to use to get these predictions. It was really hard overall because I don't think I really grasped how simple (asterisk) AI is. What I mean by that is all it ended up being was slightly convoluted math. This project definitely humbled me, I thought I knew much more AI concepts than I did. I also thought finance concepts at this level were much simpler than they really are. I would give this project a 100000/10 for effort and learning. Also stay tuned for my next AI, which will have a hidden layer and backprop and stuff once I figure that out.
